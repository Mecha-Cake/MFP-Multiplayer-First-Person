...
public class bl_HeadBob : MonoBehaviour {
    ...
    [SerializeField]
    Transform head = null;							// the object to which the head-bob movement should be applied
    ...
    [SerializeField]
    AudioClip jumpSound = null;				// the sound played when character leaves the ground.
    [SerializeField]
    AudioClip landSound = null;				// the sound played when character touches back on ground.
