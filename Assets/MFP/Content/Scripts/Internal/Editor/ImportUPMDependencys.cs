...
public class ImportUPMDependencys
{
    ...
    {
        File.Delete("Assets/MFP/Content/Scripts/Internal/Editor/ImportUPMDependencys.cs.meta");
        File.Delete("Assets/MFP/Content/Scripts/Internal/Editor/ImportUPMDependencys.cs.cs");
    }
    ...
    static void Progress()
    {
        if (Request.IsCompleted)
        {
            ...
            if (Request.Status == StatusCode.Success)
            {
                ...
                Debug.Log("Reimporting MFP assets to integrate post processing...");
#if UNITY_2019_3_OR_NEWER
                AssetDatabase.Refresh();
                var folder = AssetDatabase.LoadAssetAtPath("Assets/MFP", typeof(UnityEngine.Object));
                Selection.activeObject = folder;
                EditorApplication.ExecuteMenuItem("Assets/Reimport");
#else
                AssetDatabase.ImportAsset("Assets/MFP", ImportAssetOptions.Default | ImportAssetOptions.ForceUpdate | ImportAssetOptions.ImportRecursive);
#endif
